...
def question_form():
    ...
    class QuestionForm(FlaskForm):
        ...
        q0 = None if len(_question) <= 0 else StringField("Question", default=_question[0], validators=[ReadOnly()])
        noun0 = None if len(_noun) <= 0 else StringField("Noun", default=_noun[0], validators=[ReadOnly()])
        descr0 = None if len(_description) <= 0 else StringField("Description", default=_description[0], validators=[ReadOnly()])
        sel1 = SelectField('Choice',choices=[('', '')] + _choices, validators=[DataRequired()])
        q1 = None if len(_question) <= 1 else StringField("Question", default=_question[1], validators=[ReadOnly()])
        noun1 = None if len(_noun) <= 1 else StringField("Noun", default=_noun[1], validators=[ReadOnly()])
        descr1 = None if len(_description) <= 1 else StringField("Description", default=_description[1], validators=[ReadOnly()])
        sel2 = SelectField('Choice',choices=[('', '')] + _choices, validators=[DataRequired()])
        q2 = None if len(_question) <= 2 else StringField("Question", default=_question[2], validators=[ReadOnly()])
        noun2 = None if len(_noun) <= 2 else StringField("Noun", default=_noun[2], validators=[ReadOnly()])
        descr2 = None if len(_description) <= 2 else StringField("Description", default=_description[2], validators=[ReadOnly()])
        sel3 = SelectField('Choice',choices=[('', '')] + _choices, validators=[DataRequired()])
        q3 = None if len(_question) <= 3 else StringField("Question", default=_question[3], validators=[ReadOnly()])
        noun3 = None if len(_noun) <= 3 else StringField("Noun", default=_noun[3], validators=[ReadOnly()])
        descr3 = None if len(_description) <= 3 else StringField("Description", default=_description[3], validators=[ReadOnly()])
        sel4 = SelectField('Choice',choices=[('', '')] + _choices, validators=[DataRequired()])
        q4 = None if len(_question) <= 4 else StringField("Question", default=_question[4], validators=[ReadOnly()])
        noun4 = None if len(_noun) <= 4 else StringField("Noun", default=_noun[4], validators=[ReadOnly()])
        descr4 = None if len(_description) <= 4 else StringField("Description", default=_description[4], validators=[ReadOnly()])
        submit = SubmitField()
